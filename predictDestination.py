...
def feature_generator(time, startadr):
    ...
    cluster_model = joblib.load(os.path.join(current_dir, "k-means_cluster.pkl"))
...
if __name__ == "__main__":
    predict("2016-02-29 23:15:47", "BP, Broadway, Brooklyn, Kings County, New York, 11207, United States")
